...
<style>
 ...
 <body class="bootstrap"  >
						...
						<div class="panel-heading">
							...
							<span class="panel-title">
								...
								<ul class="nav nav-tabs">
									<li class="active"><a href="#letters" data-toggle="tab"><i class="glyphicon glyphicon-th-list"></i> Take Exam</a></li>
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label">Select Subject</label>
    <div class="col-sm-5">
	<select class="form-control">
  <option>Default select</option>
</select>
  ...
  <button type="submit" class="btn btn-primary mb-2">Search Exam</button>
</form>
