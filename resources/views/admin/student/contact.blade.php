...
<style>
 ...
 <body class="bootstrap"  >
						...
						<div class="panel-heading">
							...
							<span class="panel-title">
								...
								<ul class="nav nav-tabs">
									<li><a href="#emails" data-toggle="tab"><i class="glyphicon glyphicon-plus"></i> Admin</a></li>
    ...
    <label for="staticEmail" class="col-sm-2 col-form-label">Admin</label>
    <div class="col-sm-5">
  ...
  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
					<textarea id="editor1" class="form-control" name="body" placeholder="Add Note"></textarea>
                    </div>
                </div>
</form>
