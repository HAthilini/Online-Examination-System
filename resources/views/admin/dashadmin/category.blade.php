						...
						<div class="panel-heading">
							...
							<span class="panel-title">
								...
								<ul class="nav nav-tabs">
									<li class="active"><a href="#letters" data-toggle="tab"><i class="glyphicon glyphicon-list"></i> Category List</a></li>
									<li><a href="#emails" data-toggle="tab"><i class="glyphicon glyphicon-plus"></i>Add Category</a></li>
						...
						<div class="panel-body">
							...
							<div class="tab-content">
                                 ...
                                 <div class="tab-pane fade in active" id="letters">
									...
									<THEAD>
										<TR><TH>Category Name</TH><TH>Subject Name</TH><TH>Option</TH></TR>
									</THEAD>
									<TBODY>
									@foreach($subjects as $subject)<TR><TD>{{$subject->category_name}}</TD><TD>{{$subject->subject_name}}</TD><TD><a  href="{{url('admin/dashadmin/edit/'.$subject->id)}}" class="btn btn-success">
                          <span>Edit</span></a></TD><TD>
						  <form action="{{url('admin/dashadmin/category/'.$subject->id)}}" method="post">
						  {{method_field('DELETE')}}
						  {{csrf_field()}}
						  <button  class="btn btn-success">Delete</button>
								 ...
								 <FORM ACTION="/savecategory" METHOD="post">
                                    ...
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="inputSubject" placeholder="Category Name">
                                    </div>
                                     </div>
