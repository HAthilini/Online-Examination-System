...
<style>
 ...
 <body class="bootstrap"  >
						...
						<div class="panel-heading">
							...
							<span class="panel-title">
								...
								<ul class="nav nav-tabs">
									<li class="active"><a href="#letters" data-toggle="tab"><i class="glyphicon glyphicon-list"></i>Notice List</a></li>
									<li><a href="#emails" data-toggle="tab"><i class="glyphicon glyphicon-send"></i> Add Notice</a></li>
						...
						<div class="panel-body">
							...
							<div class="tab-content">
								 ...
								 <FORM ACTION="" >
									...
									<THEAD>
										<TR><TH>Notice Subject</TH><TH style="text-align:left">Notice Date</TH><TH style="text-align:left">Notice</TH><TH style="text-align:left">Option</TH></TR>
									</THEAD>
									<TBODY>
									@foreach($notices as $notice)<TR><TD>{{$notice->Notice_subject}}</TD><TD>{{$notice->Notice_date}}</TD><TD>{{$notice->Notice}}</TD><TD><a  href="{{url('admin/dashadmin/editnotice/'.$notice->id)}}" class="btn btn-success">
                          <span>Edit</span></a></TD><TD>
						  <form action="{{url('admin/dashadmin/notice/'.$notice->id)}}" method="post">
						  {{method_field('DELETE')}}
						  {{csrf_field()}}
						  <button  class="btn btn-success">Delete</button>
									...
									<INPUT TYPE="submit" CLASS="btn btn-outline btn-default" VALUE="Add Notice">
								</FORM>
								</div>
    ...
    <input type="text" class="form-control" name="inputcategory1"  >
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Notice Date</label>
    <input type="text" class="form-control" name="inputcategory2" >
   
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Notice</label>
 
	<textarea id="editor1" class="form-control" name="inputcategory3" ></textarea>
