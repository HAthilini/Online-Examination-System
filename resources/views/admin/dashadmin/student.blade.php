						...
						<div class="panel-heading">
							...
							<span class="panel-title">
								...
								<ul class="nav nav-tabs">
									<li class="active"><a href="#letters" data-toggle="tab"><i class="glyphicon glyphicon-list"></i> Student List</a></li>
									<li><a href="#emails" data-toggle="tab"><i class="glyphicon glyphicon-plus"></i>Add Student</a></li>
						...
						<div class="panel-body">
							...
							<div class="tab-content">
                                 ...
                                 <div class="tab-pane fade in active" id="letters">
									...
									<THEAD>
										<TR><TH>Category Name</TH><TH>Student Name</TH><TH>Registration Number</TH><TH>Option</TH></TR>
									</THEAD>
									<TBODY>
									@foreach($students as $student)<TR><TD>{{$student->Category_name}}</TD><TD>{{$student->student_name}}</TD><TD>{{$student->Reg_number}}</TD><TD><a  href="{{url('admin/dashadmin/studentedit/'.$student->id)}}" class="btn btn-success">
                          <span>Edit</span></a></TD><TD>
						  <form action="{{url('admin/dashadmin/student/'.$student->id)}}" method="post">
						  {{method_field('DELETE')}}
						  {{csrf_field()}}
						  <button  class="btn btn-success">Delete</button>
						  </form>
						  
						  </TD><TD><a  href="{{url('admin/dashadmin/viewstudent/'.$student->id)}}" class="btn btn-success">
                          <span>View</span></a></TD></TR>@endforeach
								 ...
								 <FORM ACTION="/savestudent" METHOD="post">
                                    ...
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="inputstudent1" >
                                    </div>
                                     </div>
									 <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Student Name</label>
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="inputstudent2" >
                                    </div>
                                     </div>
									 <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Registration Number</label>
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="inputstudent3" >
                                    </div>
                                     </div>
									 <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Date Of Birth</label>
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="inputstudent4" >
                                    </div>
                                     </div>
									 <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Address</label>
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="inputstudent5" >
                                    </div>
                                     </div>
									 <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="inputstudent6" >
                                    </div>
                                     </div>
									 <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">PassWord</label>
                                    <div class="col-sm-5">
                                    <input type="text" class="form-control" name="inputstudent7" >
                                    </div>
                                     </div>
